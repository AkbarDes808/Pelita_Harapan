...
$items = query("SELECT * FROM cart, users WHERE cart.username=users.username AND status!='Cart' AND status!='Selesai' ORDER BY id_cart");
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($items as $item) : ?>
                                                <tr>
                                                    <td><?= $i++; ?></td>
                                                    <td><strong><a href="order.php?id_order=<?= $item['id_order']; ?>">#<?= $item['id_order']; ?></a></strong></td>
