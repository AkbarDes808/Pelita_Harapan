...
if (isset($_POST['addCategory'])) {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $tambahKategori = CRUD("INSERT INTO kategori (kategori) VALUES ('$namaKategori')");
                                    ...
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($kategori as $kat) : ?>
                                                <tr>
                                                    <td><?= $i++; ?></td>
                                                    <td><img src="../assets/img/collection/<?= $kat['gambar']; ?>" width="30px">
                                                    <td><?= $kat['kategori']; ?></td>
                                                    <td><a href="hapusKategori.php?kategori=<?= $kat['kategori']; ?>" class="text-danger">Hapus</a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="addCategory">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
